...
class CartController extends Controller
{
    ...
    public function updateCart($id,$qty=0){
    ...
    public function complete(){
        ...
        $html_output = view('cart/complete',compact('cart_items','cust_name','cust_email','po_no','po_date','total_amount'));
        $mpdf = new \Mpdf\Mpdf();
        $mpdf->debug = true;
    ...
    public function finish_order(){
        $cart_item = Session::get('cart_items');
